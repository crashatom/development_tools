...
@property(nonatomic) NSDictionary *curVideoMeta;
@property(nonatomic) NSDictionary *curAudioMeta;
@property(nonatomic) NSDictionary *curSubtitleMeta;

@property(nonatomic) NSMutableArray *videoLists;
@property(nonatomic) NSMutableArray *audioLists;
@property(nonatomic) NSMutableArray *subtitleLists;
