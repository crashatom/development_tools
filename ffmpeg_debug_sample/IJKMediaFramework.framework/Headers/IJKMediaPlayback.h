...
@optional
//*************
//IJKFFMoviePlayerController.m 已声明，但h文件未声明
...
//***Android's snapshot interface is not avariable in Ios***
...
@property (nonatomic) float playbackVolume;@property (nonatomic) int nVideoTrack;@property (nonatomic) int nAudioTrack;@property (nonatomic) int nSubtitleTrack;
